...
// 구동을 위한 기본 설정을 읽어들이는 파일임!(페이지를 보여주는 셋팅)

// express를 부른다 : express 기본 모듈 import
...
// dest 속성에 값으로 셋팅!
// 커스터마이징없이 기본 dest로 업로드 위치를 셋팅하면
// 폴더가 없을경우 폴더를 생성해 준다!
...
const storage = multer.diskStorage({
    ...
    destination: function(req,file,setPath){
        ...
        // 여기지정하면 자동으로 uploads 파일을 만들지 않음!
    },
...
// -> 첫번째 값은 루트 아래에 업로드 관련 post 전송을 선택
