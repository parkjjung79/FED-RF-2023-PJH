...
export function GList() {
  ...
  return (
    <main id="cont">
      ...
      <section>
        <div id="optbx">
          <label for="men">남성</label> <input type="checkbox" id="men" />{" "}
          <label for="women">여성</label> <input type="checkbox" id="women" />{" "}
          <label for="style">스타일</label> <input type="checkbox" id="style" />
        </div>
