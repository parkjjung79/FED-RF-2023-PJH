...
export function GList() {
  ...
  const makeList = () => {
    ...
    // 2. Paging List ////////////////
      ...
      // -> 이것을 배열에 담을때는 변환이 필요없다
      // -> 그대로 보내서 출력함! (JSX는 이미 변환처리준비가 다 되어있는 상태임)
      retVal = []; // 배열형 할당!
  ...
  *******************************************/
  const changeList = (e) => {
    ...
    // 6. 검색결과 리스트 업데이트 하기
    // 위의 분기문에서 만들어진 참조변수 데이터를 최종 업데이트한다!
