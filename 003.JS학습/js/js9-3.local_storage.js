//JS9-3.로컬스토리지 JS - local_storage.js
...
function insData(){
    ...
    // if(!orgData)의 의미는 null 일때 들어가고 싶어!
    if(!orgData){
        // 빈 배열로 생성하기
