...
// JS외부파일은 html문서에 직접 들어가 작동되므로 CSS처럼 'utf-8' 인코딩 설정이 필요없음!
...
function insertMini(){
    ...
    // length -> 전체개수를 읽기(길이라는 뜻이지만 개수도 length임)

    console.log('미니개수:', count_mini, typeof count_mini);
    // typeof 변수 -> 변수의 데이터형 출력!


    // 출력대상 : .stxt span -> cnt_spot 변수에 담음
    // 미니언즈가 개당 3개씩 이므로 *3
