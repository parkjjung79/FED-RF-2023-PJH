...
// 데이터 파일을 모두 불러온 후에 그 데이터를 이용하는 코드가 실행되도록 하는
// 비동기 코딩방식인 Promise를 사용하는 것이 원칙이다!

console.log(langCode);

// 1. 다국어 요구사항
// - 언어선택박스를 변경하면 해당 코드에 맞게 다국어 데이터를
