//JS6-1.Date객체와 Math객체 - Date_Math.js
...
// 3. 시간찍기 -> 함수안으로 들어가야 실시간으로 초가 바뀜
// JS 시간 날짜 객체 : Date() 객체
// const today = new Date();
//  new키워드로 내장객체의 인스턴트를 생성함!
...
function showTime() {
  ...
  // 참고 : getYear()는 1900년을 뺀 년도가 나옴 -> 컴퓨터의 역사가 20세기 부터시작되어서!
  console.log("tt");
  ...
  // 12보다 크면 12를 빼주고 작으면 한자리일때 0처리는 항상해줌!

  // 3-6. 오전/오후 출력
  // 기준 12시 보다 크면 오후, 작으면 오전
...
// 이미지를 칼라로 약간 커지게 클래스 on을 주어서 변경하기
