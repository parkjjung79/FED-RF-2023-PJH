...
export default function TopArea(props) {
  ...
  // useLayoutEffect(함수,[])-> 뒤에 의존성변수 구역 비어있으면
  // 본 컴포넌트가 처음 실행될때 한 번만 실행한다!
...
function GnbMenu(props) {
  ...
  // 부모의 컨텍스트 프로바이더 value에 셋팅된 이름으로 호출한다!
