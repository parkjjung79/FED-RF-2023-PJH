...
function MainComponent() {
  ...
  /******************************************** 
    ...
    기능: 상태관리변수 중 데이터 선택번호 업데이트를
    하여 화면의 상품리스트를 업데이트한다!
  ********************************************/
  // 데이터 변경호출 함수 //////////
  const chgData = () => {
    console.log('바꿔~!');
    // 데이터 키 후크변수를 업데이트함
    setDataNum(dataNum?0:1); // set의 의미는 연쇄반응을 시켜주는 것(트리거)
  ...
  ********************************************/
  ...
  return (
    <React.Fragment>
      ...
      <section>
        <h2>{
        dataNum?'효진은 오늘도 쨍합니다!':
        '공유는 오늘도 멋찝니다!'}</h2>
        {/* 이미지 */}
        <div className="img-box">
        <img src={dataNum?
        "./images/gallery/hyojin.jpg":
        "./images/vans/gongyoo.jpg"}
        alt={dataNum?"쨍한효진":"멋진공유"} />
        </div>
      </section>
      {/* 3. 데이터 변경 버튼 */}
