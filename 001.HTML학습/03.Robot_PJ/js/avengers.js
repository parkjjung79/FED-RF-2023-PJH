...
// 새로고침시 맨 위로 이동!
setTimeout(()=>{windowscrollTo(0,0)},500);
...
window.addEventListener('wheel',(e)=>{
    ...
    // 두번째 페이지일때 동영상 플레이하기!
    if(e.wheelDelta<0){ //아래로내려갈때 - 자동플레이
        qs('.trailer-box iframe')
        .src='https://www.youtube.com/embed/Ko2NWhXI9e8?autoplay=1'
    } //////////////// if /////////////////////
    else{ //위로 올라올때 - 멈춤
        qs('.trailer-box iframe')
        .src='https://www.youtube.com/embed/Ko2NWhXI9e8'
    } /////////////// else ///////////////////
